...
##This is a Python Django foundation web development package. It contains a basic root template with commonly used style sheets and various useful third party JavaScript libraries. Also, a basic Django application structure with some minimal sample testing.
